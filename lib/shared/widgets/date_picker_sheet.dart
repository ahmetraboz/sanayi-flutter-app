...
class _DatePickerSheetState extends State<DatePickerSheet> {
  ...
  List<({int? day, String str})> get _cells {
    ...
    for (var i = 0; i < firstDow; i++) { cells.add((day: null, str: '')); }
            ...
            children: [
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Icon(Icons.chevron_left, size: 20, color: _canGoPrev ? AppColors.gray600 : AppColors.gray300),
                ),
              ),
              ...
              GestureDetector(
                ...
                child: Container(
                  width: 32, height: 32,
                  decoration: BoxDecoration(color: AppColors.gray100, borderRadius: BorderRadius.circular(8)),
                  child: const Icon(Icons.chevron_right, size: 20, color: AppColors.gray600),
                ),
              ),
            ],
          ),
          ...
          Row(
            children: _weekdays.map((wd) => Expanded(
              child: Center(child: Text(wd,
                  style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: AppColors.gray400))),
            )).toList(),
          ),
