    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            const Text('İşlerim', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: AppColors.gray900)),
            const Text('Kabul ettiğiniz ve üzerinde çalıştığınız talepler',
                style: TextStyle(fontSize: 12, color: AppColors.gray500, fontWeight: FontWeight.normal)),
          ],
        ),
        actions: [
          if (!state.loading)
