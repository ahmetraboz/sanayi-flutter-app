    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            const Text('İşletme Profili', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: AppColors.gray900)),
            const Text('İşletme bilgilerinizi güncelleyin', style: TextStyle(fontSize: 12, color: AppColors.gray500, fontWeight: FontWeight.normal)),
          ],
        ),
        actions: [
          IconButton(
